...
namespace Buses.WebAPI
{
    ...
    {
        private PivotClient olapClientHelper = new PivotClient();
        private PivotTreeMap treeMapHelper = new PivotTreeMap();
        private PivotChart chartHelper = new PivotChart();
        private JavaScriptSerializer serializer = new JavaScriptSerializer();
        private static int cultureIDInfoval = 1033;
