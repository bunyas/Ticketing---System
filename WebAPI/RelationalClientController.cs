...
namespace Buses.WebAPI
{
    public class RelationalClientController : ApiController
    {
        ...
        private string conStringforDB = "DataSource=" + HttpContext.Current.Server.MapPath(".").Split(new string[] { "\\api" }, StringSplitOptions.None)[0] + "\\App_Data\\ReportsTable.sdf; Persist Security Info=False";
        ...
        public Dictionary<string, object> FetchMembers(Dictionary<string, object> jsonResult)
        {
            ...
            Dictionary<string, object> dict = pivotClient.GetJsonData(jsonResult["action"].ToString(), ProductSales.GetSalesData(), jsonResult["headerTag"].ToString());
            return dict;
        }
        ...
        {
            pivotClient.PopulateData(jsonResult["currentReport"].ToString());
            Dictionary<string, object> dict = pivotClient.GetJsonData(jsonResult["action"].ToString(), ProductSales.GetSalesData(), jsonResult["sortedHeaders"].ToString());
            return dict;
        }
        ...
        {
            pivotClient.PopulateData(jsonResult["currentReport"].ToString());
            Dictionary<string, object> dict = pivotClient.GetJsonData(jsonResult["action"].ToString(), ProductSales.GetSalesData(), jsonResult["filterParams"].ToString());
            return dict;
        }
        ...
        public Dictionary<string, object> FetchReportListFromDB(Dictionary<string, object> jsonResult)
        {
            ...
            Dictionary<string, object> dictionary = new Dictionary<string, object>
            {
                ...
                { "action", jsonResult["action"].ToString() }
            };
            return dictionary;
        }
        ...
        internal class ProductSales
        {
            ...
            public static ProductSalesCollection GetSalesData()
            {
                ...
                for (int i = 0; i < numberOfRecords; i++)
                {
                    ...
                    {
                        Country = countries[r.Next(1, countries.GetLength(0))],
