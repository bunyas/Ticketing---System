...
namespace Buses.Controllers
{
    ...
    {
        private PdfViewerHelper helper = new PdfViewerHelper();
        ...
        public object Load(Dictionary<string, string> jsonResult)
        {
            ...
            {
                string name = jsonResult["newFileName"];
                string pdfName = name.ToString();
        ...
        public object FileUpload(Dictionary<string, string> jsonResult)
        {
            ...
            {
                string fileurl = jsonResult["uploadedFile"];
    ...
    public class Helper
    {
        ...
        private static string GetCommonFolder(DirectoryInfo dtInfo)
        {
            DirectoryInfo[] _folderNames = dtInfo.GetDirectories("Data/PdfViewer");
