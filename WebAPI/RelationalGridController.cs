...
namespace Buses.WebAPI
{
    ...
    {
        private PivotGrid htmlHelper = new PivotGrid();
        private JavaScriptSerializer serializer = new JavaScriptSerializer();
        private Dictionary<string, object> dict = new Dictionary<string, object>();
        private static readonly int cultureIDInfoval = 1033;
        private static readonly string connectionString = ConfigurationManager.ConnectionStrings["Adventure Works"].ConnectionString + "locale identifier=" + cultureIDInfoval + ";";
